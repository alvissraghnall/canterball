...
<section class="border-y border-outline-variant bg-surface-container-low py-20">
	<div class="mx-auto grid max-w-[1440px] grid-cols-1 gap-8 px-[24px] md:grid-cols-2 lg:grid-cols-4">
		<div class="p-6 text-center">
			<p class="mb-2 font-jetbrains text-xs tracking-widest text-tertiary uppercase">Active Matches</p>
			<p class="text-3xl font-bold text-white">{matches.toLocaleString()}</p>
			<div class="mx-auto mt-4 h-1 w-12 bg-lemon-lime"></div>
		</div>
		<div class="p-6 text-center">
			<p class="mb-2 font-jetbrains text-xs tracking-widest text-tertiary uppercase">Players Online</p>
			<p class="text-3xl font-bold text-white">{players.toLocaleString()}</p>
			<div class="mx-auto mt-4 h-1 w-12 bg-dusty-grape"></div>
		</div>
		<div class="p-6 text-center">
			<p class="mb-2 font-jetbrains text-xs tracking-widest text-tertiary uppercase">Global Rank Avg</p>
			<p class="text-3xl font-bold text-white">ELITE II</p>
			<div class="mx-auto mt-4 h-1 w-12 bg-outline"></div>
		</div>
		<div class="p-6 text-center">
			<p class="mb-2 font-jetbrains text-xs tracking-widest text-tertiary uppercase">Server Latency</p>
